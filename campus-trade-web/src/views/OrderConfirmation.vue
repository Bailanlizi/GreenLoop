    ...
    <div v-if="product">
      ...
      <div class="delivery-section">
       ...
       <div class="action-footer">
          ...
          <el-button type="primary" size="large" @click="submitOrder" :loading="submitting" class="action-btn">提交订单</el-button>
       </div>
    </div>
...
<style scoped>
.box-card { max-width: 800px; margin: auto; width: 100%; }
...
@media (max-width: 600px) {
  .delivery-option-content { padding: 12px; }
  .action-footer { flex-direction: column; align-items: flex-start; gap: 12px; }
  .total-price { margin-right: 0; }
}
</style>
