<template>
  <div class="form-container">
    <el-card class="form-card">
      ...
      <div class="link-area">
         <router-link to="/login" class="btn-info link-pill">已有账号？直接登录</router-link>
      </div>
    </el-card>
  </div>
</template>
...
<style scoped>
.form-container { display: flex; justify-content: center; align-items: center; padding: 40px 16px; }
.form-card { width: 100%; max-width: 460px; }
.link-area { text-align: center; margin-top: 10px; }
@media (max-width: 600px) {
  .form-container { padding: 24px 12px; }
}
</style>
