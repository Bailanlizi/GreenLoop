<template>
  <div>
    ...
    <el-skeleton :loading="loading" animated>
      ...
      <template #template>
        <el-row :gutter="30">
          <el-col :xs="24" :md="12"><el-skeleton-item variant="image" style="width: 100%; height: 400px;" /></el-col>
          <el-col :xs="24" :md="12">
            ...
            <el-col :xs="24" :md="12">
              ...
              <div class="action-buttons">
                <div v-if="isOwner" class="action-btn-group">
                  <el-button type="primary" :icon="Edit" @click="editProduct" class="action-btn">编辑商品</el-button>
                  <el-button type="danger" :icon="Delete" @click="delistProduct" class="action-btn">下架商品</el-button>
                </div>
                <div v-else class="buyer-actions action-btn-group">
                  <el-button type="primary" :icon="ChatDotSquare" @click="contactSeller" class="action-btn">联系卖家</el-button>
                  <el-button
                    :icon="Star"
                  ...
                  <el-button type="success" size="large" :icon="Goods" @click="buyNow" class="action-btn">立即购买</el-button>
                </div>
              </div>
            </el-col>
          </el-row>
...
.product-title { font-size: 16px; color: var(--color-text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin: 0 0 8px 0; }
